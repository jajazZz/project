...
function showTabContent(tab) {
    ...
    document.getElementById('toPay_content').style.display = 'none';
    document.getElementById('inReview_content').style.display = 'none';
    document.getElementById('done_content').style.display = 'none';
    document.getElementById('bill_preview').style.display = 'none';
    document.getElementById(tab).style.display = 'block';
}

function showBillPreview(tab) {
